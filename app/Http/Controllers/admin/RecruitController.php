...
class RecruitController extends Controller
{
    ...
    public function index2()
    {
       ...
       return view('admin.recruit.index2',compact('recruits'));
    }
    public function index3()
    {
       $recruits=Recruit::select('*')->orderBy('created_at', 'desc')->paginate(10);
       return view('admin.recruit.index3',compact('recruits'));
    }
    ...
    {       
        ...
        if ($recruit) {
            ...
            return redirect()->route('admin.recruit.list');
        }
        else {
    ...
    public function show($id)
    {
        ...
        return view('admin.recruit.show',compact('res'));
    }
