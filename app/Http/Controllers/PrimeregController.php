...
class PrimeregController extends Controller
{
    ...
    {     
       ...
       return view('user.properties.index',compact('propties'));
    }
    ...
    public function create()
    {
        ...
        return view('user.properties.create',compact('department'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($prop) {
            ...
            return redirect()->route('user.primereg.list');
        }
    ...
    public function show($id)
    {
        ...
        return view('user.properties.show',compact('res'));
    }
    public function vshow($id)
    {
        ...
        return view('user.properties.vshow',compact('res'));
    }
    ...
    {     
       ...
       return view('user.properties.vending_index',compact('propties'));
    }
    ...
    {
        $department=Departments::select('id','department_name')->get();
        return view('user.properties.createreg',compact('department'));
    }
...
$status = "purchasing";
        ...
        if ($prop) {
            ...
            return back();
             ...
             Toastr::error('Something went wrong :)','error');
            return redirect()->route('user.primevending.list');
        }
