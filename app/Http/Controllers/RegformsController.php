...
$forms= Regforms::select('*')->orderBy('created_at', 'desc')->get();
        return view('user.regforms.index',compact('forms'));
    }
    ...
    {
      return view('user.regforms.create');
    }
    ...
    { 
         $res= Regforms::find($id);
     
        return view('user.regforms.show',compact('res'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('user.regforms.edit')->with('edforms',$edforms);
    }
      ...
      $upregforms = DB::table('regforms')
              ...
              ->update(
                  [ 
                    ...
                    'date_commencing' => $request->date_commencing,
                ]);
    ...
    public function createPDF()
    {
        ...
        $pdf = PDF::loadView('user.pdf.regforms', compact('pdfprint'));

        return $pdf->stream('user.pdf.regforms', array('Attachment' => false));
    }
