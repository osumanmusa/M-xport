                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    ...
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="{{url('/user/view-sales/'.$sale->id)}}"><em class="icon ni ni-focus"></em><span>View</span></a></li>
                                                                                    <li><a href="{{url('/user/edit-regforms/'.$sale->id)}}"><em class="icon ni ni-eye"></em><span>Edit</span></a></li>
                                                                                    <li><a href="{{url('/user/delete-sales/'.$sale->id)}}"><em class="icon ni ni-repeat"></em><span>Delete</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
