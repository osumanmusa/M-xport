                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h4 class="nk-block-title page-title">Training</h4>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    ...
                                                                    <div class="user-info">
                                                                        <span class="tb-lead">{{$form->name}} <span class="dot dot-success d-md-none ml-1"></span></span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-mb">
                                                                <span class="currency">{{$form->company}}</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg">
                                                                <ul class="list-status">
                                                                    <li> <span>{{$form->role}}</span></li>
                                                                </ul>
                                                            </td>
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    ...
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="{{url('/user/show-regforms/'.$form->id)}}"><em class="icon ni ni-focus"></em><span>View</span></a></li>
                                                                                    <li><a href="{{url('/user/edit-regforms/'.$form->id)}}"><em class="icon ni ni-eye"></em><span>Edit</span></a></li>
                                                                                    <li><a href="{{url('/user/delete-regforms/'.$form->id)}}"><em class="icon ni ni-repeat"></em><span>Delete</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
