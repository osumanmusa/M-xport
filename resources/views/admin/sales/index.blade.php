                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt"><a href="/user/create-sales" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Add New</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head-content -->
                                    ...
                                    <div class="nk-block  ">
                                        ...
                                        <div class="card card-bordered card-preview">
                                            ...
                                            <div class="card-inner">
                                              <p>  <!--<a class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Import</span></a>-->
                                                ...
                                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                    <thead>
                                                        <tr class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <th class="nk-tb-col tb-col-lg"><span class="sub-text">Whatsapp</span></th>
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    <div class="user-avatar bg-dim-primary d-none d-sm-flex">
                                                                        <span>{{$sale->name[0]}}</span>
                                                                    </div>
                                                                    <div class="user-info">
                                                                        <span class="tb-lead">{{$sale->name}} <span class="dot dot-success d-md-none ml-1"></span></span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-mb">
                                                                <span class="currency">{{$sale->company}}</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg">
                                                                <ul class="list-status">
                                                                    <li> <span>{{$sale->role}}</span></li>
                                                                </ul>
                                                            </td>
                                                                ...
                                                                <ul class="nk-tb-actions gx-1">
                                                                    ...
                                                                    <li>
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="{{url('/admin/view-sales/'.$sale->id)}}"><em class="icon ni ni-focus"></em><span>View</span></a></li>
                                                                                    <li><a href="{{url('/admin/edit-regforms/'.$sale->id)}}"><em class="icon ni ni-eye"></em><span>Edit</span></a></li>
                                                                                    <li><a href="{{url('/admin/delete-sales/'.$sale->id)}}"><em class="icon ni ni-repeat"></em><span>Delete</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
