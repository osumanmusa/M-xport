                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt"><a href="/admin/create-primereg" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Add New</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head-content -->
                                                ...
                                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                    <thead>
                                                        <tr class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <th class="nk-tb-col tb-col-lg"><span class="sub-text">Property Location</span></th>
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    <div class="user-avatar bg-dim-primary d-none d-sm-flex">
                                                                        <span>{{$property->client_name[0]}}</span>
                                                                    </div>
                                                                    <div class="user-info">
                                                                        <span class="tb-lead">{{$property->client_name}} <span class="dot dot-success d-md-none ml-1"></span></span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-mb">
                                                                <span class="currency">{{$property->client_phone}}</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg">
                                                                <ul class="list-status">
                                                                    <li> <span>{{$property->client_email}}</span></li>
                                                                </ul>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md">
                                                                <span>{{$property->client_location}}</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-lg">
                                                                        ...
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    ...
                                                                                    <li><a href="{{url('/admin/show-prime/'.$property->id)}}"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
