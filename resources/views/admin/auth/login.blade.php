...
<body class="nk-body bg-white npc-default pg-auth">
    ...
    <!-- app-root @e -->
    <!-- JavaScript -->
    <script src="{{asset('dash/assets/js/bundle.js?ver=2.9.1')}}"></script>
    <script src="{{asset('dash/assets/js/scripts.js?ver=2.9.1')}}"></script>
